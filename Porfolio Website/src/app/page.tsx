      ...
      <main>
        <section className="grid grid-cols-1 md:grid-cols-2 lg:gap-80 overflow-hidden    items-center justify-between lg:pt-16 sm:pt-40 pt-40  overflow-x-hidden h-screen">
          <div className=" max-w-lg ml-20 flex flex-col gap-5">
            ...
            <p>
              {`I am a skilled Data Analyst, Web Developer, and Power BI
              Developer, specializing in transforming data into insights and
              building user-friendly web solutions to help you achieve your
              goals.`}
            </p>
            <div>
          ...
          <Image
            className="object-contain mr-20 pb-10"
            src={"/images/2.png"}
            height={400}
            width={400}
            alt={""}
            ...
            <div className="flex flex-col items-center justify-center space-y-8 text-center">
              <div className="space-y-4">
                ...
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                 {` I offer a wide range of services, including data science, data
                  analysis, web development, and Power BI dashboard creation. No
                  matter what your project needs, I have the skills to help you
                  succeed.`}
                </p>
              </div>
        ...
        <section className="my-32 space-y-28">
          <div className="flex flex-col gap-5 justify-center text-center items-center">
            ...
            <p className="max-w-[900px] text-gray-700 dark:text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
              {`Select the perfect plan tailored to your needs, whether you're
              looking for expert data analysis, cutting-edge data science
              solutions, or innovative web development services.`}
            </p>
          </div>
              ...
              <Card className="p-5  ">
                ...
                <CardContent>
                  <div className="space-y-2">
                    <h4>
                      Starts from <span className="text-4xl">$14.99</span>
                    </h4>
                  </div>
                  <div>
