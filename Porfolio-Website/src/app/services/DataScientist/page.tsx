...
const DataScienceServices = () => {
  ...
  <section className='w-screen flex flex-col items-center justify-center gap-3'>
    ...
    <h1 className='max-w-4xl text-4xl md:text-5xl lg:text-6xl xl:text-7xl text-center font-normal leading-tight'>
      Empowering Your Business With Data-Driven Solutions
    </h1>
    <div className='flex flex-col md:flex-row gap-4 md:gap-8 mt-3'>
      <Button className='rounded-full p-4 md:p-6 pl-2 text-lg md:text-xl'>
        <span className='bg-white p-1 text-xl md:text-2xl text-black rounded-full mr-3'>
          <MdElectricBolt />
        </span> 
        Check Services
      </Button>
      <Button className='rounded-full p-4 md:p-6 pl-2 text-lg md:text-xl' variant={"secondary"}>
