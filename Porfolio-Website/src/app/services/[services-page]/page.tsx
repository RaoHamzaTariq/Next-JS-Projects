...
const ServicesPage = ({params}:{params:any}) => {
  const router = useRouter()
  console.log(params["services-page"])
  ...
  return (
    <main className='py-28 md:py-40'>
      <section className='w-screen flex flex-col items-center justify-center gap-3'>
        ...
        <h1 className='md:max-w-6xl text-4xl md:text-5xl lg:text-6xl xl:text-7xl text-center font-semibold leading-tight'>
