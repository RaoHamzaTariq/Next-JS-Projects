          ...
          <div className="container mx-auto px-4">
            <div className="grid gap-8 py-12 md:py-16 md:grid-cols-2 lg:gap-16">
              ...
              <div className="space-y-6 md:space-y-8">
                ...
                <div className="space-y-4 text-center md:text-left">
                  ...
                  <p className="text-muted-foreground max-w-md mx-auto md:mx-0 dark:text-gray-400">
                      Empowering Decisions Through Data and Automating the bussinesses
                  </p>
                </div >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12">
                ...
                <div className="space-y-4 text-center md:text-left">
                  <h4 className="font-bold text-lg bg-gradient-to-r from-primary via-primary/90 to-primary/70 bg-clip-text text-transparent dark:from-primary dark:via-primary/90 dark:to-primary/70">
                    Portfolios
                  </h4>
                  <ul className="space-y-3">
                    {[
                      {
                        ...
                        href: "/portfolios?category=Data Analyst"
                      },
                      {
                        title: "AI Agents",
                      ...
                      <li key={service.href}>
                        <Link href={service.href}>
                          <span className="text-muted-foreground hover:text-primary transition-all duration-300 hover:translate-x-1 inline-block cursor-pointer dark:text-gray-400 dark:hover:text-primary">
                            {service.title}
                          </span>
                        </Link>
                      </li>
                ...
                <div className="space-y-4 text-center md:text-left">
                  ...
                  <ul className="space-y-3">
                    <li>
                      <Link href="#faqs" className="text-muted-foreground hover:text-primary transition-all duration-300 hover:translate-x-1 inline-block dark:text-gray-400 dark:hover:text-primary">
                        FAQs
                      </Link>
                    </li>
                    <li>
                      <Link href="/About" className="text-muted-foreground hover:text-primary transition-all duration-300 hover:translate-x-1 inline-block dark:text-gray-400 dark:hover:text-primary">
                        About Us
                      </Link>
                    </li>
                    <li className="text-muted-foreground hover:text-primary transition-all duration-300 hover:translate-x-1 inline-block cursor-pointer dark:text-gray-400 dark:hover:text-primary">Our Policy</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div className="py-6 md:py-8 flex flex-col sm:flex-row justify-between items-center gap-4 md:gap-6">
              ...
              <div className="text-center sm:text-left">
                <p className="text-sm text-muted-foreground">
                  This is my portfolio website created by <span className="text-primary hover:text-primary/80 font-medium transition-colors hover:underline decoration-primary/30 hover:decoration-primary/60">Rao Hamza Tariq</span>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4 md:gap-6">
                <div className="flex items-center gap-4">
                  ...
                  <Link 
                    href="https://www.upwork.com/freelancers/~01c73bcca9bafbd6b9" // Replace with your actual Upwork profile URL
                    target="_blank"
                    className="p-2 rounded-full bg-primary/10 text-primary hover:bg-primary hover:text-primary-foreground transition-all duration-300 hover:scale-110"
